...
export default function Data({ formData, rulerData, manualCurveData, areaData, angleData, bodyConditionData, pixelDimension }) {
  ...
  // Define styles with improved contrast
  const headingStyle = {
    color: "#222222"
  };
      ...
      <div className="data-content">
        {formData && (
          <div className="form-data">
            ...
            <p><strong style={dataLabelStyle}>Focal Length:</strong> {format(formData.focalLength)}</p>
            <p><strong style={dataLabelStyle}>Altitude:</strong> {format(formData.altitude)}</p>
            <p><strong style={dataLabelStyle}>Altitude Offset:</strong> {format(formData.altitudeOffset)}</p>
            <p><strong style={dataLabelStyle}>Image Width:</strong> {format(formData.imageWidth)}</p>
            <p><strong style={dataLabelStyle}>Image Height:</strong> {format(formData.imageHeight)}</p>
            <p><strong style={dataLabelStyle}>Field of View:</strong> {format(formData.fov)}</p>
            <p><strong style={dataLabelStyle}>Sensor Width:</strong> {format(formData.sensorWidth)}</p>
            <p><strong style={dataLabelStyle}>Width Segments:</strong> {format(formData.widthSegments)}</p>
            <p><strong style={dataLabelStyle}>Crosshair Size:</strong> {format(formData.crosshairSize)}</p>
            <p><strong style={dataLabelStyle}>Crosshair Opacity:</strong> {format(formData.crosshairOpacity)}</p>
            <p><strong style={dataLabelStyle}>Segment Color:</strong> {format(formData.segmentColor)}</p>
            <p><strong style={dataLabelStyle}>Pixel Dimension:</strong> {format(pixelDimension)}</p>
          </div>
        )}

        {rulerData && (
          <div className="measurement-data">
            <h3 style={headingStyle}><span aria-hidden="true">📏</span> Ruler Measurements</h3>
            <p>
              <strong style={dataLabelStyle}>Type:</strong> {rulerData.type}
            </p>
            <p>
              <strong style={dataLabelStyle}>Curve Length:</strong> {rulerData.curveLength.toFixed(2)} m
            </p>
            <p>
        ...
        {manualCurveData && (
          <div className="measurement-data">
            <h3 style={headingStyle}><span aria-hidden="true">✏️</span> Manual Curve</h3>
            <p>
              <strong style={dataLabelStyle}>Curve Length:</strong> {manualCurveData.curveLength.toFixed(2)} m
            </p>
            <p>
              <strong style={dataLabelStyle}>Points:</strong> {manualCurveData.curvePoints.length}
            </p>
          </div>
        )}
        ...
        {areaData && (
          <div className="measurement-data">
            <h3 style={headingStyle}><span aria-hidden="true">🔲</span> Area Measurement</h3>
            <p>
              <strong style={dataLabelStyle}>Area:</strong> {areaData.area.toFixed(2)} m²
            </p>
            <p>
              <strong style={dataLabelStyle}>Points:</strong> {areaData.polygonPoints.length}
            </p>
          </div>
        )}
        ...
        {angleData && (
          <div className="measurement-data">
            <h3 style={headingStyle}><span aria-hidden="true">📐</span> Angle Measurement</h3>
            <p>
              <strong style={dataLabelStyle}>Angle:</strong> {angleData.angle.toFixed(2)}°
            </p>
            <p>
              <strong style={dataLabelStyle}>Points:</strong> {angleData.anglePoints.length}
            </p>
          </div>
        )}
        ...
        {bodyConditionData && (
          <div className="measurement-data">
            ...
            {bodyConditionData.areaIndex && (
              <p>
                <strong style={dataLabelStyle}>Body Area Index:</strong> {bodyConditionData.areaIndex.toFixed(2)}
              </p>
            )}
            {bodyConditionData.surfaceArea && (
              <p>
                <strong style={dataLabelStyle}>Surface Area:</strong> {bodyConditionData.surfaceArea.toFixed(2)} m²
              </p>
            )}
            {bodyConditionData.fullResults && Object.entries(bodyConditionData.fullResults)
              ...
              .map(([key, value]) => (
                <p key={key}>
                  <strong style={dataLabelStyle}>{key}:</strong> {typeof value === 'number' ? value.toFixed(2) : value}
                </p>
              ))
            }
          </div>
