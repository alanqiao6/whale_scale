...
export default function Login({ setIsLoggedIn, setShowLogin, setUsername }) {
   ...
   const handleCreateAccount = async (e) => {
     ...
     try {
       ...
       const response = await axios.post('http://localhost:8000/api/create-account', { username, password });
