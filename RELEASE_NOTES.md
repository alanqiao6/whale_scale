...
- ✅ Interactively place and move crosshairs along the whale body to calculate **curved length**
...
- No persistent user storage or session history beyond login (for now).
